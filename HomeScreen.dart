...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    if (value == 'Smartphones') {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const SmartPhones()),
      );
    }
    if (value == 'Laptops') {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const Laptops()),
      );
    }
    if (value == 'Fragrances') {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const Fragrances()),
      );
    }
    if (value == 'Skincare') {
      Navigator.push(
    ...
    if (value == 'Home Decoration') {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const Homedecor()),
      );
    }
    ...
    child: Text(
      ...
      style: const TextStyle(fontSize: 19, color: Colors.blueAccent, decoration: TextDecoration.underline),
      textAlign: TextAlign.right,
      ),
    ),
    ],
